...
describe('Money', () => {
  ...
  describe('comparison methods', () => {
    ...
    it('should compare money amounts correctly', () => {
      expect(money1.compareTo(money2)).toBe(5000); // 100 BRL = 10000 cents, 50 BRL = 5000 cents
      expect(money2.compareTo(money1)).toBe(-5000);
  ...
  describe('formatting', () => {
    it('should format money correctly', () => {
      ...
      // Verifica se contém os elementos básicos do formato
      const formatted = money.format();
      expect(formatted).toContain('R$');
      expect(formatted).toContain('1.234'); // Com ponto como separador de milhares
